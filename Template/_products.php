 				...
 				<div class="row">
 					<div class="col-sm-6">
 						<img
 							...
 							alt="product"
 							class="img-fluid" />
 						<div class="row pt-4 g-2 font-size-16 font-baloo">
 								<div class="col">
 								...
 								<div class="col">
 									<?php
										if (in_array($item['item_id'], $Cart->getCartId($product->getData('cart')) ?? [])) {
											echo '<button type="submit" disabled class="btn btn-success form-control font-size-16">
									in the Cart
								</button>';
										} else {
											echo '<button type="submit" name="top_sale_submit" class="btn btn-warning form-control font-size-16">
									Add to Cart
								</button>';
										}
										?>
 					...
 					<div class="col-sm-6 py-5">
 							...
 							<div class="d-flex">
 								<div class="return text-center me-5">
 									<div class="font-size-20 my-2 color-second">
 										<span
 											class="fas fa-retweet border p-3 rounded-pill"></span>
 									</div>
 								...
 								<div class="return text-center me-5">
 									...
 									<a href="#" class="font-rale font-size-12">HopSoft-Tech <br />Delivered</a>
 								</div>
 								<div class="return text-center">
 									<div class="font-size-20 my-2 color-second">
 										<span
 											class="fas fa-check-double border p-3 rounded-pill"></span>
 									</div>
 						...
 						<div
 							...
 							<small>Delivery by : Aug 29 - Sep 7</small>
